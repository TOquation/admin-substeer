      ...
      <div className="overflow-y-auto">
                ...
                {selected.attachments.map((attachment, index) => (
                  <div key={index} className="">
                    ...
                    <div className="text-[0.62rem]">
                      <p className="text-gray-600 truncate">{attachment.id}</p>
                      <a
        ...
        <div className="p-4 pt-2 space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <button className="flex-1 px-2 py-1.5 flex items-center justify-center font-medium text-green-500 cursor-pointer text-sm bg-black rounded-full hover:bg-green-600 hover:text-black transition-colors">
              Create Ticket
              <span>
